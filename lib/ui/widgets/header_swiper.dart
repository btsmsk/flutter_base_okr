...
class SwiperHeader extends StatefulWidget {
  ...
  const SwiperHeader({required this.urls, Key? key}) : super(key: key);
...
class _SwiperHeaderState extends State<SwiperHeader> {
  ...
  Widget build(BuildContext context) => Swiper(
        ...
        itemBuilder: (context, index) => CachedNetworkImage(
          ...
          errorWidget: (context, index, error) => Icon(Icons.image, size: 40, color: Theme.of(context).textTheme.caption?.color),
